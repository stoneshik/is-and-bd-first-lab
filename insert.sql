...
VALUES
    ...
    (1, 3, 2, default, 'Видеограмма апельсина', 'Привет! Смотри какой апельсин я засняла'),
    (2, 2, 3, default, 'Видеограмма Невы', 'Привет! Ты засняла прекрасный вид Невы на фоне вечернего неба')
    ;
