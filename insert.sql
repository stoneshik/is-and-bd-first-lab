...
VALUES
    ...
    (3, 2, 'Видео апельсина', default, random_bytea(812)),
    (4, 3, 'Видео Невы', default, random_bytea(400))
    ;
...
VALUES
    ...
    (1, 2, 3, default, 'Видеограмма апельсина', 'Привет! Смотри какой прекрасный оранжевый апельсин'),
    (2, 3, 2, default, 'Видеограмма Невы', 'Привет! Недавно приехал в Питер, смотри как красива Нева на фоне вечернего неба')
    ;
